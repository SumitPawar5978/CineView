...
import { setUpcomingMovies } from '../features/movie/movieSlice';
...
const Upcoming = () => {
  ...
  const moviesToDisplay = searchResults.length > 0 ? searchResults : upcomingMovies;
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-900 min-h-screen">
      <h1 className="text-4xl font-bold mb-8 text-center text-white">Upcoming Movies</h1>
